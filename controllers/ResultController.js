...
const Student = require("../models/student");   // ✅ FIXED
const Subject = require("../models/subject");   // ✅ FIXED
...
class ResultController {
  ...
  static getMyResult = async (req, res) => {
    try {
      // req.user.id is the User._id. Find the corresponding Student document
